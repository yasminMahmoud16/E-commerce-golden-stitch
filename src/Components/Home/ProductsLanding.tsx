...
export default function ProductsLanding() {
    ...
    useEffect(() => {
        if (categorySlugUrl && catSize?.docs) {
            const matchedCategory = catSize.docs.find(
                (cat) => cat.slug === categorySlugUrl
            );
            if (matchedCategory) {
    ...
    }, [categorySlugUrl, catSize, setCategoryId]);
                    ...
                    <div className="flex items-center justify-center flex-wrap gap-4 pb-4">
                        <div className="flex flex-wrap justify-center gap-4 pb-4 items-center">
                            {isLoading ? (
                                ...
                                <div className="text-center capitalize text-dark-blue-2 font-semibold text-lg mt-10">
