    ...
    <>
      <section className="min-h-screen h-full">
        <div className="grid grid-cols-1 md:grid-cols-6 min-h-screen shadow-[0_0_10px_rgba(242,217,153,0.1)]">
          ...
          {/* Left Side */}
          <div className="hidden md:flex md:flex-col  md:items-center md:justify-center col-span-2 bg-radial from-dark-blue-1 via-dark-blue-2 to-dark-blue-nav h-full">
            <OrderConfirmSide />
